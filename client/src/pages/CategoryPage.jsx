  ...
  return (
    <section>
      <div className='p-4 top- bg-white shadow-md flex items-center justify-between'>
        ...
        <button onClick={()=>setOpenUploadCategory(true)} className='text-sm border border-primary-200 hover:bg-primary-100 px-3 p-1 rounded'>Add category</button>
      </div>
          ...
          <div className=' p-4 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4'>
              {
                ...
                categoryData.map((category, index) => {
                  return (
                    <div key={category._id} className=' w-32 h-50 group object-scale-down shadow-md rounded  '>
                      <img 
                      src={category.image} 
      ...
      {
        openEidit && (
          <EditCategory data={editCategoryData} fetchData={fetchCategory} close={()=>setOpenEidit(false)}/>
        )
      }
      {
