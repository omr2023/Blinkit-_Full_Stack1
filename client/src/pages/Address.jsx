    ...
    <div className="">
      <div className="bg-white shadow-lg px-2 py-2 font-semibold flex item-center justify-between gap-4">
        <h2 className=" text-ellipsis line-clamp-1">
          <span className="text-green-600">A</span>ddress
        </h2>
        <button
          onClick={() => setOpenAdress(true)}
          className="border-green-600 rounded-full  p-2 bg-green-400 hover:bg-green-500 text-white"
        >
          Add address
        </button>
      </div>
      <div className="bg-blue-50 p-2 grid  gap-4 font-semibold">
        {addressList.flat().map((address, index) => {
          return (
            <div
              key={index}
              className={`border rounded p-3 flex gap-4 hover:bg-white ${
            ...
            >
              ...
              <div className="px-2 flex items-center justify-center gap-2">
                ...
                <button
                  ...
                  className="bg-red-300 p-1 rounded-full text-white hover:bg-red-600"
                >
                  <MdDelete size={25} />
                </button>
              </div>
