  ...
  return (
    <div className='w-36 p-4 bg-white rounded'>
            ...
            <div className='grid grid-cols-2 gap-2 my-2 '>
              <button onClick={()=>setEditOpen(true)} className=' border px-1 py-1 text-sm  text-green-400 hover:bg-green-200 border-green-400 hover:text-green-500'>Edit</button>
              <button onClick={()=>setOpenDelete(true)} className=' border px-1 py-1 text-sm text-red-500 hover:bg-red-300 border-red-400 hover:text-red-600'>Delete</button>
            </div>
            {
              editOpen && (
