...
const CaardProduct = ({data}) => {
  ...
  return (
     <Link to={url} className='border p-4 grid gap-3 max-w-52 lg:min-w-52 rounded cursor-pointer bg-white'>
            ...
            <div>
                {
                    Boolean(data.discount) &&(
                        <p className='text-green-600 bg-green-100 px-2 p-1 rounded-full w-fit text-sm'>{data.discount}% discount</p>
                    )
                }
            </div>
            </div>
