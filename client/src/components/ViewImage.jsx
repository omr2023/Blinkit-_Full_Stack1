...
const ViewImage = ({url , close}) => {
  return (
    <div className='fixed top-0 bottom-0 right-0 left-0 bg-neutral-900 bg-opacity-70 flex justify-center items-center z-50 p-4'>
        <div className='w-full max-w-md max-h-[80vh] p-4 bg-white relative'>
        <button onClick={close} className='absolute top-2 right-2 text-gray-500 hover:text-gray-800 transition-colors'>
            <IoClose size={25}/>
        </button>
