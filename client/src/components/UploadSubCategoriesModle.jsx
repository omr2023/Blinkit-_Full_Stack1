    ...
    <section className="fixed top-0 left-0 w-full h-full bg-black/50 z-50 flex items-center justify-center">
      <div className="w-full max-w-6xl bg-white p-4 rounded">
        <div className="flex items-center justify-between gap-3 mb-4">
          ...
          <button
            onClick={close}
            className="p-1 rounded hover:bg-gray-100 hover:text-red-400 transition-colors"
          >
        ...
        >
          <div className="grid gap-2">
            ...
            <input
              ...
              type="text"
              className="w-full p-2  border border-gray-300 rounded outline-none focus-within:border-primary-200"
          ...
          <div className="border p-2 rounded focus-within:border-primary-200">
            ...
            <div className="flex flex-wrap gap-2">
              {subCategoryData.category.map((cat, index) => {
                return (
                  ...
                  <p
                    key={cat._id + "selactdValue"}
                    className="bg-yellow-50 m-2 shadow-md text-primary-900 px-2 py-1 rounded flex items-center justify-between gap-2"
                  >
                    {cat.name}
                    <div
            ...
            <select
              onChange={(e) => {
                ...
                const categoryIndex = allCategorie.find(
                  (el) => el._id == value
                );
